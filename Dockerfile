...
cmd  /bin/bash -c "mkdir -p /opt/marker && cd /opt/marker && git clone --recursive https://github.com/OlegJakushkin/GridAndCloud_base ; cd ./GridAndCloud_base && python mark.py"
